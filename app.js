...
function multiply(a,b){ //eslint-disable-line
  ...
  var message = 'The product of ' + a + ' and ' + b + ' is ' + prodOfTwoNums + '.';
  return [prodOfTwoNums, message];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  var prodCount = sumAndMultiply(testArray[0], testArray[1], testArray[2])[1];
  var message = 'The numbers ' + testArray + ' have a product of ' + prodCount + '.';
  return [prodCount, message];
}
